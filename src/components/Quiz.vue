<template>
  <container>
    <div id="hero" class="p-4 sm:p-8 mx-auto max-w-lg">
      <!-- Tengah dengan lebar maksimum -->
      <!-- Add padding to the entire container, increase padding on small screens (sm) -->
      <div v-if="currentQuestionIndex < questions.length" class="text-left">
        ...
        <ul>
          ...
          >
            ...
            <label
              ...
              class="text-base"
              :class="{
                'bg-green-500 text-white font-semibold p-2 rounded':
